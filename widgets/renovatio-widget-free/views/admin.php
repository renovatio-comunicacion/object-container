...
<p>
    ...
    foreach ( $categories as $c ) {
        //if ( $c->parent != $currentCat ) continue;
...
<p>
    <label for="<?php echo $this->get_field_id('short_url'); ?>"><?php _e( 'Short URL:' ); ?></label>
    <input type="text" 
           class="widefat" 
           id="<?php echo $this->get_field_id('short_url'); ?>" 
           value="<?php echo $instance['short_url']; ?>"
           name="<?php echo $this->get_field_name('short_url'); ?>"/>
</p> 